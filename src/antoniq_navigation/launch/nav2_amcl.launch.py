...
def launch_setup(context, *args, **kwargs):
    ...
    localization = GroupAction([
        ...
        IncludeLaunchDescription(
            ...
            condition=IfCondition(LaunchConfiguration("launch_amcl")),
            launch_arguments={
                'namespace': namespace,
                'map': config_map,
    ...
    return [localization, navigation2_cmd]
...
def generate_launch_description():
    ...
    declared_arguments.append(
        DeclareLaunchArgument("launch_nav2", default_value="false", description=""))
    declared_arguments.append(
        DeclareLaunchArgument("launch_amcl", default_value="false", description=""))
